...
public class PatientProcHandler {
    ...
    private String header = "Code, Date, Description, Price";
    ...
    public void writeCSV(List<PatientProcedureRecord> procedures, String filename) throws IOException {
        ...
        try {
            ...
            for (PatientProcedureRecord patientProcedureRecord : procedures) {
                procedure_file.append(patientRecord.getP_Ic());
        ...
        try {
            ...
            while ((line = bReader.readLine()) != null) {
                ...
                if (values.length >= 0) {
                    ...
                    PatientProcedureRecord procedure = new PatientProcedureRecord(values[0],values[1],values[2],values[3],values[4]);
